              ...
              {filteredApps.map((app) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-center mt-2 text-xs">
                    <span className="text-green-500 flex items-center gap-2 bg-green-100 px-2 py-1 rounded">
                      <FaDownload />
                      {app.downloads}
                    </span>

                    <span className="flex items-center gap-1 text-orange-500 bg-amber-100 px-2 py-1 rounded">
                      <FaStar />
                      {app.ratingAvg}
                    </span>
                  </div>
